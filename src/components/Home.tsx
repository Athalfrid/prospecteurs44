...
const Home: React.FC<HomeProps> = ({ user, userProfile }) => {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] bg-gray-50 text-gray-800 font-sans">
            ...
            <section className="relative bg-gradient-to-r py-20 px-6 text-center md:py-32 md:px-12">
                ...
                <div className="relative max-w-4xl mx-auto">
                    ...
                    <h1 className="mt-4 mb-4 text-4xl md:text-6xl font-black text-gray-900 tracking-tight">
                        Prospecteurs<span className="text-amber-600">44</span>
                    </h1>
                    <p className="mt-6 text-lg md:text-xl text-gray-600  mx-auto leading-relaxed">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                        <button className="bg-amber-600 hover:cursor-pointer hover:bg-amber-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg transition transform hover:-translate-y-0.5" onClick={() => navigate('/presentation')}>
            ...
            <section className="max-w-6xl mx-auto -mt-12 px-6 relative z-10">
                <div className="bg-white border border-red-100 rounded-2xl shadow-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <button className="w-full md:w-auto bg-gray-900 hover:cursor-pointer hover:bg-gray-800 text-white font-semibold px-6 py-3 rounded-xl transition" onClick={() => navigate('/declarer-sos')}   >
            ...
            <section className="max-w-6xl mx-auto px-6 py-20">
                {user && userProfile?.is_validated ? (
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 text-center max-w-2xl mx-auto shadow-sm">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 mt-2 mb-2">Inscription en cours de traitement</h3>
            ...
            <section className="bg-gray-900 text-gray-100 py-16 px-6">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                    ...
                    <p className="text-gray-400 leading-relaxed mx-auto text-sm md:text-base">
